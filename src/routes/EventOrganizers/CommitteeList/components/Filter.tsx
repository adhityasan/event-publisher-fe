...
const Filter: React.FC<IFilterProps> = ({ onFilter }) => {
  ...
  console.log(categoriesOptions, formatOptions);
      ...
      <Row gutter={[12, 12]} justify="start">
        <Col xs={24} md={12} lg={8} className="for-column">
          <Form.Item label="Search" name="search">
            <Input.Search placeholder="search name or email" />
          </Form.Item>
          <Form.Item label="Join Date" name="date">
            <DatePicker.RangePicker placeholder={['starts from', 'until']} />
          </Form.Item>
        </Col>
        <Col xs={24} md={12} lg={8} className="for-column"></Col>
        <Col xs={24} md={12} lg={8} className="for-column">
          <Row gutter={[12, 12]} justify="start" align="bottom">
            <Col xs={24} md={12}>
